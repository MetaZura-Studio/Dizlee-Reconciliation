...
import { mapReportStatusToSubmissionStatus } from "@/lib/partner/queries/dashboard";

describe("partner dashboard period helpers", () => {
...
describe("partner dashboard submission status mapping", () => {
