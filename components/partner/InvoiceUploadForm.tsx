    ...
    <form onSubmit={handleSubmit} className="max-w-3xl space-y-6">
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="sm:col-span-2">
          <label htmlFor="invoice-opco" className="text-sm font-medium text-zinc-700">
            OpCo
          </label>
          <select
            id="invoice-opco"
        ...
        <div>
          <label htmlFor="invoice-year" className="text-sm font-medium text-zinc-700">
            Year
          </label>
          <input
            id="invoice-year"
        ...
        <div>
          <label htmlFor="invoice-month" className="text-sm font-medium text-zinc-700">
            Month
          </label>
          <input
            id="invoice-month"
        ...
        <div className="sm:col-span-2">
          <label htmlFor="invoice-file" className="text-sm font-medium text-zinc-700">
            Invoice PDF
          </label>
          <input
            id="invoice-file"
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          {lineItems.map((line, index) => (
            <div
              key={index}
              className="grid gap-3 rounded-lg border border-zinc-200 p-4 sm:grid-cols-4"
            >
              <div className="sm:col-span-2">
