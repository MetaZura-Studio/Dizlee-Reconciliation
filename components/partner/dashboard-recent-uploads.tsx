/**
 * Partner dashboard recent uploads — sortable columns and client pagination.
 */
...
import type { RecentUploadSummary } from "@/lib/partner/queries/dashboard";
...
type UploadSortField = "opco" | "period" | "status" | "uploadedAt";
...
function compareUploads(
  ...
  switch (sortBy) {
    ...
    case "period": {
      ...
      return (
        (aPeriod - bPeriod || a.opcoName.localeCompare(b.opcoName)) * dir
      );
    }
    case "status":
      return (
        (a.statusLabel.localeCompare(b.statusLabel) ||
          a.opcoName.localeCompare(b.opcoName)) *
        dir
      );
    case "uploadedAt":
    default:
