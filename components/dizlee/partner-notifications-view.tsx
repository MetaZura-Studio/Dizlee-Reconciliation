    ...
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-xl border border-zinc-200 bg-white p-4">
          <h2 className="text-lg font-medium text-zinc-900">Compose message</h2>
          <p className="mt-1 text-sm text-zinc-500">
          ...
          <div className="mt-4 space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between gap-3">
                <span className="text-sm text-zinc-600">Recipients (Partners)</span>
        ...
        <div className="rounded-xl border border-zinc-200 bg-white p-4">
          <h2 className="text-lg font-medium text-zinc-900">Recent messages</h2>
          <p className="mt-1 text-sm text-zinc-500">
          ...
          <div className="mt-4 space-y-3">
            {result.items.length === 0 ? (
              <p className="text-sm text-zinc-500">No partner messages sent yet.</p>
            ) : (
