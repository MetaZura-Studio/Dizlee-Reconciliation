      ...
      >
        <form onSubmit={(event) => void submit(event)}>
          <div className="space-y-4 px-6 py-5">
            <h2 id="currency-form-title" className="text-lg font-semibold text-zinc-900">
            ...
            <div className="space-y-1">
              <label htmlFor="isoCode" className="text-sm font-medium text-zinc-700">
                ISO code
              </label>
              <input
                id="isoCode"
                ...
                disabled={mode === "edit"}
                required
                className="w-full rounded-md border border-zinc-300 px-3 py-2 text-sm uppercase outline-none focus:border-zinc-500 disabled:bg-zinc-100"
              />
            </div>

            <div className="space-y-1">
              <label htmlFor="symbol" className="text-sm font-medium text-zinc-700">
                Symbol
              </label>
              <input
                id="symbol"
