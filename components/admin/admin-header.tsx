    ...
    <header className="flex h-14 items-center justify-between border-b border-border bg-surface px-4 lg:px-6">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="rounded-md border border-border px-3 py-1.5 text-sm text-foreground-subtle"
        >
          Search
        </button>
        ...
        <div className="relative" ref={menuRef}>
          <button
            ...
            className="flex items-center gap-2 rounded-md border border-border px-3 py-1.5 text-sm hover:bg-surface-muted"
          ...
          {menuOpen ? (
            ...
            >
              ...
              <Link
                ...
                role="menuitem"
                className="block px-4 py-2 text-sm text-foreground-muted hover:bg-surface-muted"
              ...
              <div className="px-4 py-2">
                <SignOutButton
                  ...
                  label="Log out"
                  className="w-full rounded-md border border-border px-3 py-1.5 text-left text-sm text-foreground-muted hover:bg-surface-muted"
                />
              </div>
            </div>
          ) : null}
