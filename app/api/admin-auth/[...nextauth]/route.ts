/**
 * GET, POST — Admin auth portal.
 * Separate NextAuth handler with Admin-only cookie namespace so Admin can stay
 * logged in alongside OpCo/Partner/Dizlee on the same origin.
 */
